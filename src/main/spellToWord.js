const dict = require('./spell-dict-jian.json');
const initialDict = require('./info-dict.json').initial;

const arg = {simple: 'simple', trad: 'trad', poly: 'poly', alltone: 'alltone', array: 'array'};
let _ = {};// 工具方法
